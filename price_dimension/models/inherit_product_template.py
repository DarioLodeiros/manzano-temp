...
class product_template(models.Model):
    ...
    height_attr = fields.Many2one('product.attribute',string='Height Attribute')
    width_attr = fields.Many2one('product.attribute',string='Width Attribute')
...
#     cost_prices_table = fields.One2many('product.prices_table', 'cost_product_tmpl_id', string="Cost Prices Table")
    ...
    def _price_get(self, cr, uid, products, ptype='list_price', context=None):
        ...
        for product in products:
            ...
            if ptype != 'standard_price'and product._name == "product.product":
